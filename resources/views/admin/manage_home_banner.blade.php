                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                         ...
                                         <div class="col-md-6">
                                            <label for="category_name" class="control-label mb-1">Bannner Hading/text</label>
                                            <input id="btn_txt" value="{{$bn_txt}}" name="bn_txt" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                        </div>
                        
                         <div class="col-md-6">
                                            <label for="category_name" class="control-label mb-1">Meta Desc</label>
                                            <input id="m_desc" value="{{$m_desc}}" name="m_desc" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                        </div>
