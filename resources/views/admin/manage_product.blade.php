   ...
   <div class="col-md-12">
      <form action="{{route('product.manage_product_process')}}" method="post" enctype="multipart/form-data">
         <div class="row">
            <div class="col-lg-12">
               <div class="card">
                  <div class="card-body">
                     ...
                     <div class="form-group">
                        <label for="warranty" class="control-label mb-1"> Product-URL</label>
                     ...
                     @endif
                           ...
                           <div class="col-md-3">
                              <label for="model" class="control-label mb-1">is Fetured</label>
            ...
            <h2 class="mb10 ml15">Product More Images</h2>
            <div class="col-lg-12">
               <div class="card">
                  <div class="card-body">
                     <div class="form-group">
